/*virtualinput aggiornato 22/01/2011*/ 
#include <gtk/gtk.h>
#include <gdk/gdk.h>
#include <X11/Xlib.h>
...
void ins(struttura *str)
{
 ...
 str->modifier=0;
 gtk_label_set_text (GTK_LABEL (str->mylabel),"");
 gtk_label_set_text (GTK_LABEL (str->mylabel),"ins new word,↵");
...
{
 GtkWidget *frame, *framet9, *winbox, *box,*cbox, *tbox, *table;//nuovo x lista
