/*virtualinput aggiornato 10/01/2011*/ 
#include <gtk/gtk.h>
#include <X11/Xlib.h>
...
funz listF_Buttons[NUM_OF_BUTTONS]={fButtonShift,fButtonAltGR,fButtonDelete,fButtonSpace,fButtonEnter,fButtonTP,fButtonTab,fButtonIns};
...
/* Crea una FrameT9 */
 ...
 gtk_widget_set_usize(scrolled_window, NULL, NULL);
