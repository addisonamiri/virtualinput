...
typedef struct tstruttura{
 ...
 Window win;
 Window winRoot;
 lbutton listButton1,listButton2,listButton4,listButton5,listButton6,listButton7,listButton8,listButton9,listButton10,listButton11,listButton12;
}struttura;
...
int button1[9]={7,0,XK_quotedbl,XK_comma,XK_plus,XK_minus,XK_less,XK_quoteright,XK_period};
/*len;event.state,1;2;3;4;5;6;7;8;9;0;\;,;+;-;<;';.;*/
int button0[20]={18,1,XK_bar,XK_exclam,XK_2,XK_3,XK_dollar,XK_percent,XK_ampersand,XK_slash,XK_parenleft,XK_parenright,XK_equal,XK_question,XK_asciicircum,XK_asterisk,XK_greater,XK_semicolon,XK_colon,XK_underscore};
/*len,event.state,|,!,£,$,&,/,(,),=,?,^,*,>,;,:,_, */
...
{
 sendKey(str->display,str->win,str->winRoot,button1[3],button1[1]); 
 //printf("1\n");
}
...
int main(int argc, char *argv[])
{
 ...
 int vetb1[7]={XK_quotedbl,XK_comma,XK_plus,XK_minus,XK_less,XK_quoteright,XK_period};
 str.listButton1.simbol=setListButton(7,0,vetb1,str.listButton1);  
 printf("%d   %d\n",str.listButton1.simbol[1],XK_comma);
