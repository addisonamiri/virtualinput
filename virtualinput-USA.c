...
#define LENB1 18                             /*the number of symbols in the button 1*/
...
#define PATH_DB "/usr/share/virtualinput/virtualinput-0.3beta-USA/dictionary.sqlite"
//#define PATH_DB "dictionary.sqlite"
#define PATH_IMG "/usr/share/virtualinput/virtualinput-0.3beta-USA/keyboard_icon.gif"
...
int main(int argc, char *argv[])
{
 ...
 int keycodemap[LENB*6+LENB1+LENB7_9*2+LENB0]={ 
                                          96,XK_1,XK_quoteright,XK_period,XK_question,XK_exclam,XK_comma,XK_colon,
